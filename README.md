...
- 若你**对外分发**本软件或其修改版，须遵守 GPLv3：随附许可证副本，并向接收方提供完整的对应源代码。
- **不希望承担上述开源义务？** 例如需将本项目并入**闭源产品**对外分发，或对外提供商业化的分发与服务 —— 可购买**企业版**，免除 GPLv3 的全部开源义务：📧 **sj7suren@hotmail.com**
- 本软件按"原样"提供，不附带任何明示或暗示的担保。

> 商业授权详情见下方[企业版与商业授权](#企业版与商业授权)。
