...
- **个人与企业自行使用，完全免费。** 包括在生产环境中使用、按需修改，无需付费，也无需任何额外授权。
- **若要将本项目二次转售给其他个人或单位**，需事先取得作者的**书面许可**；或直接联系作者采购**企业版**：📧 **sj7suren@hotmail.com**
- 若你对外分发本软件或其修改版，须遵守 GPLv3：随附许可证副本，并向接收方提供完整的对应源代码。
- 本软件按"原样"提供，不附带任何明示或暗示的担保。

> 转售、品牌与商标的具体界定见 [TRADEMARK.md](TRADEMARK.md)；商业授权见下方[企业版与商业授权](#企业版与商业授权)。
